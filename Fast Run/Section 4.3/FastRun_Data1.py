# -*- coding: utf-8 -*-
"""Copy of opt_Thesis0704.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1urR7DP730_V9XOO28y-oDeiihMl00VI7
...
# Преобразование каждого категориального столбца
...
def maintr_new(data, sample, best_model, optfl, modelnm, prepare_data, random_state=42):
  ...
  if optfl == 'Y':
    ...
    #display(best_params1)
    acc = accuracy_score(Ytrue,Ypred)
    #df['DataSize'] = len(data)
    df['Accuracy'] = acc
...
BestModel_rg, _ = modelfunc(data = data_prepared, modelnm = "DecTree") #main
